...
<div class="col-4">
    <form action="cities.php" method="get" style="margin-left:0px">
    <?php
...
<div class="toolbar">
    <a class="button fancybox" href="editCity.php?id=0&<?php echo $ltoken; ?>">
        Προσθήκη πόλης
    </a> 
</div>
...
$gridCities = new datagrid("gridCities", $db1, 
        "", 
        array("id","description"), 
        array("ID", "ΟΝΟΜΑ"),
        $ltoken, 0, 
        TRUE, "editCity.php", "ΑΝΟΙΓΜΑ",
        TRUE, "delCity.php", "ΔΙΑΓΡΑΦΗ"
        );
