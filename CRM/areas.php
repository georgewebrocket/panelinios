...
<body>
    ...
    <div class="main">
        ...
        <h2><?php echo $l->l("list_areas"); ?></h2>
        
        <div class="toolbar">
            <a class="button fancybox" href="editArea.php?id=0&<?php echo $ltoken; ?>"><?php echo $lg->l("add"); ?></a> 
        </div> 
        ...
        <div class="col-10">
                <div class="articles">
                    ...
                    $gridAreas = new datagrid("gridAreas", $db1,
                            "SELECT * FROM AREAS WHERE parentid=0 ORDER BY description", 
                            array("description"), 
