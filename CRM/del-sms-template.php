...
$id = $_GET['id'];
$smsTempl = new SMS_TEMPLATES($db1,$id);
$templateName = $smsTempl->get_description();
...
<form action="del-sms-template.php?id=<?php echo $id; ?>&confirm=1&<?php echo $ltoken; ?>" method="POST">
