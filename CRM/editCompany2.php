...
if ($company->get_lockedbyuser()==1 && $company->get_lockuser()!=$_SESSION['user_id']) {
    ...
    $lockmsg = "ΑΥΤΗ Η ΚΑΤΑΧΩΡΗΣΗ ΕΙΝΑΙ ΚΛΕΙΔΩΜΕΝΗ ΑΠΟ ΤΟΝ ΧΡΗΣΤΗ ".$userfullname;
}
...
if (isset($_GET['save']) && $_GET['save'] == 1) {
    ...
    if ($err==0) {
        ...
        $company->set_geo_x(trim($_POST['txtGeoX']));
        $company->set_geo_y(trim($_POST['txtGeoY']));
        ...
        $company->set_catalogueid($_POST['txtCatalogueid']);
        ...
        $company->set_DeliveryNotes($_POST['txtDeliveryNotes']);
...
<meta http-equiv="Expires" content="0" />
    ...
    <script>
        ...
        function GetStats() {
            ...
            var myUrl = "https://www.epagelmatias.gr/admin/ws-stats.php?id="+company;
...
//           });
    ...
    <style>
        ...
        #t_afm, #t_doy, #t_eponimia, #cCompanyType {
    ...
    <body class="form">
        <div class="form-container" style="max-width: 1200px; margin:auto">
            
            <h1 id="top"><?php echo "Πελάτης: " . $company->get_companyname(); ?></h1>   
            ...
            if ($voucherid>0) {
                ...
                echo "<a id=\"btn-second-note-for-courier-ok\" data-voucher=\"$voucherid\" class=\"button\">ΟΚ</a>";
                echo "</div>";
            ...
            <form id="mainform" action="editcompany.php?id=<?php echo $id; ?>&save=1&<?php echo $ltoken; ?>" method="POST">
                ...
                <div class="col-12">
                    ...
                    ?>
                    <a class="button fancybox7000" href="<?php echo $statusLink; ?>">ΔΕΝ ΑΠΑΝΤΑ</a>&nbsp;
                    <?php $statusLink = $statusLink1."&status2=3"; ?>
                    <a class="button fancybox7000" href="<?php echo $statusLink; ?>">RECALL</a>&nbsp;
                    <?php $statusLink = $statusLink1."&status2=12"; ?>
                    <a class="button fancybox7000" href="<?php echo $statusLink; ?>">ΛΑΘΟΣ ΤΗΛ.</a>&nbsp;
                    
                    <?php $statusLink = $statusLink1."&status2=5"; ?>
                    <a class="button fancybox7000" href="<?php echo $statusLink; ?>"><strong>ΣΥΜΦΩΝΗΣΕ</strong></a>&nbsp;
                    
                    <?php $statusLink = $statusLink1."&status2=4"; ?>
                    <a class="button fancybox7000" href="<?php echo $statusLink; ?>">ΑΡΝΗΤΙΚΟΣ</a>&nbsp;
                    
                    <?php $statusLink = $statusLink1."&status2=15"; ?>
                    <a class="button fancybox7000" href="<?php echo $statusLink; ?>">ΑΡΝΗΣΗ ΑΝΑΝΕΩΣΗΣ</a>&nbsp;
                    <?php $statusLink = $statusLink1."&status2=17"; ?>
                    <a class="button fancybox7000" href="<?php echo $statusLink; ?>">ΣΥΝΕΧ. ΕΠΙΣΤΡ.</a>&nbsp;
                    ...
                    <?php if ($_SESSION['user_profile']>1) { ?>
                        ...
                        <a class="button fancybox7000" href="<?php echo $statusLink; ?>">ΕΠΙΣΤΡΟΦΗ</a>&nbsp;
                        <?php $statusLink = $statusLink1."&status2=16"; ?>
                        <a class="button fancybox7000" href="<?php echo $statusLink; ?>">ΑΚΥΡΩΣΗ</a>&nbsp;
                    ...
                    <a class="button" href="sendEmail.php?id=<?php echo $company->get_id(); ?>">Αποστ. email</a>&nbsp;
                    
                    &nbsp;&nbsp;&nbsp;                   
                    
                    
                    <a class="button" href="companyPrint.php?id=<?php echo $company->get_id(); ?>"><?php echo $l->l("print") ?></a>&nbsp;                    
                    
                    <?php
                    if ($company->get_profession()>0 && $company->get_city_id()>0 && $company->get_companyname()!="") {
                    
                    if ($company->get_catalogueid()!="") {  ?>
                        <a class="button" href="syncCompany.php?companyid=<?php echo $id; ?>">Συγχρ. CRM<->ONLINE</a>
                        
                        <?php if (($_SESSION['user_profile']>1)) { ?>
                            <a class="button" href="https://www.epagelmatias.gr/admin/login.php?TxtUsername=<?php echo $company->get_catalogueid(); ?>&TxtPassword=<?php echo $adminpass; ?>&BtnOK=Login">Edit company online</a>&nbsp;
                        <?php } ?> 
                            
                    <?php } else {   ?>

                        <a class="button" href="syncCompany.php?companyid=<?php echo $id; ?>">Προσθήκη στον online κατάλογο</a>
                    <?php } } else { echo "<a title=\"Επωνυμία, Επάγγελμα ή Πόλη είναι κενό\"  class=\"button\" style=\"background-color:#ccc; cursor:default\">Προσθήκη στον online κατάλογο</a>"; }  ?>
                        
                        <br/><br/>
                        
                        
                    <?php if ($company->get_catalogueid()!="") {  ?>
                    <a target="_blank" title="Ανοιγμα καταχώρησης της εταιρείας στο epagelmatias.gr" class="button" href="<?php echo $url_online; ?>">ΑΝΟΙΓΜΑ ΚΑΤΑΧΩΡΗΣΗΣ</a>&nbsp;
                    
                    <a class="button" target="_blank" href="https://www.epagelmatias.gr/assets/upd_record.php?id=<?php echo $company->get_catalogueid(); ?>">Άμεση ενημέρωση καταλόγου</a>
                    ...
                    <a title="Ανανέωση δεδομένων φόρμας" class="button" href="editcompany.php?id=<?php echo $company->get_id(); ?>"><?php echo $l->l("refresh") ?></a>&nbsp;
                    
                    <?php if ($_SESSION['user_profile']==3) { ?>
                    <a class="button fancybox7000" href="delCompany.php?id=<?php echo $id; ?>"><?php echo $l->l("delete") ?></a>&nbsp;
                    <?php } ?>
                    ...
                    <?php if ($id>0 && $_SESSION['user_profile']>1) { ?>                    
                        <a href="_cloneCompany.php?id=<?php echo $id ?>" class="button">Clone</a>                    
                    <?php } ?>
                    
                    <?php 
                    if ($company->get_parent_record()>0) { 
                        $parentId = $company->get_parent_record();
                        echo "<h3>Αυτή η καρτέλα προέρχεται από την <a href=\"editcompany.php?id=$parentId\">$parentId</a><h3>";
                    } 
                    if ($company->get_child_record()>0) { 
                        $childId = $company->get_child_record();
                        echo "<h3>Αυτή η καρτέλα μετασχηματίστηκε στην <a href=\"editcompany.php?id=$childId\">$childId</a><h3>";
                    } 
                    ?>
                    <!--GP 29/5/2019 END-->   
                    ...
                    <!--
                    <a class="button fancybox" href="editTransaction.php?id=0&company=<?php echo $company->get_id(); ?>&type=1">Νέα χρέωση</a>&nbsp;
                    <a class="button" href="editTransaction.php?id=0&company=<?php echo $company->get_id(); ?>&type=2">Νέα είσπραξη</a>&nbsp;
                    -->
                ...
                <div class="col-6 col-md-12">
                    ...
                    //basic category
//                        $cCategory = new comboBox("cCategory", $db1, 
//                                "SELECT id, CONCAT((CASE parentid WHEN 0 THEN '+ ' ELSE '--- ' END),description) AS MyDescr FROM CATEGORIES ORDER BY parentid, description", 
//                                "id","MyDescr",
//                                $company->get_basiccategory(),$l->l("category"));
...
EOT;
                    ...
                    if ($company->get_catalogueid()>0) {
                        //statistika site
                        $stats = "";
                        //$stats = file_get_contents("http://www.epagelmatias.gr/admin/ws-stats.php?id=".$company->get_catalogueid());
                ...
                <div id="products" class="col-6 col-md-12">
                    <?php
                    //$colorPackage = "#fff";
                    $colorPackage = func::vlookup("color", "PRODUCT_CATEGORIES", "id=1", $db1);
                    echo "<div style=\"clear:both; width:93%; padding:10px 1%; font-weight:bold; margin-bottom:10px; background-color:$colorPackage\">ΚΑΤΑΧΩΡΗΣΗ</div>";
                    ...
                    $txtCatalogueid = new textbox("txtCatalogueid", $l->l('catalogueid'),$company->get_catalogueid(), "");
                ...
                <div class="col-6 col-md-12">
                    ...
                    echo "<div style=\"clear:both; width:93%; padding:10px 1%; font-weight:bold; margin-bottom:10px; background-color:$colorDomain\">DOMAIN</div>";
                ...
                <div class="col-6 col-md-12">
                    ...
                    echo "<div style=\"clear:both; width:93%; padding:10px 1%; font-weight:bold; margin-bottom:10px; background-color:$colorDomain; color:#fff\">FACEBOOK</div>";
...
<!--#########################################################################-->                
                <div class="col-6 col-md-12">
                    ...
                    echo "<div style=\"clear:both; width:93%; padding:10px 1%; font-weight:bold; margin-bottom:10px; background-color:$colorDomain; color:#fff\">Google Adwords</div>";
...
<!--#########################################################################-->                    
                    <div class="col-6 col-md-12">
                        ...
                        echo "<div style=\"clear:both; width:93%; padding:10px 1%; font-weight:bold; margin-bottom:10px; background-color:$colorSrv; color:#fff\">$descrSrv</div>";
                        ...
                        $t_srv_services->set_label("Product/Services");
                ...
                <div id="courier" class="col-6 col-md-12">
                    <?php
                    
                    echo "<div style=\"clear:both; width:93%; padding:10px 1%; font-weight:bold; margin-bottom:10px; background-color:#ccc\">COURIER</div>";
                ...
                <div id="other" class="col-6 col-md-12">
                    
                    <?php
                    
                    echo "<div style=\"clear:both; width:93%; padding:10px 1%; font-weight:bold; margin-bottom:10px; background-color:#ccc\">ΑΛΛΑ ΣΤΟΙΧΕΙΑ</div>";
                ...
                <div id="messages" class="col-6 col-md-12">
                    
                    <!--MESSAGES-->

                    <?php
                    echo "<div style=\"clear:both; width:93%; padding:10px 1%; font-weight:bold; margin-bottom:10px; background-color:#ccc\">ΜΗΝΥΜΑΤΑ</div>";
                    ?>
                    
                    <iframe src="messages.php?showlist=0&companyid=<?php echo $id; ?>&popupurl=0&receiver=0<?php echo $noCacheHash; ?>" width="95%" height="250" frameborder="0"></iframe>
                ...
                <div class="col-6 col-md-12">
                    ...
                    echo "<div style=\"clear:both; width:93%; padding:10px 1%; font-weight:bold; margin-bottom:10px; background-color:#ccc\">&nbsp;</div>";
                    ...
                    <div class="message" style="margin-bottom:10px">
                        ...
                        <div style="margin-bottom:5px"><?php echo $curmessage->get_message(); ?></div>
                ...
                <div id="status" class="col-12">
                    ...
                    if ($id!=0) {                    
                        ...
                        for ($i = 0; $i < count($rs); $i++) {
                            $productCategories = str_replace(array("[", "]"), "", 
                        ...
                        echo "<div style=\"width:95%; max-height:600px; overflow:scroll\">";
                ...
                <div class="col-12">
                    ...
                    echo '<h2 style="margin:0px;padding:0px">ΧΡΕΩΣΕΙΣ</h2><br/>';
                ...
                <div class="col-6">
                    ...
                    for ($i = 0; $i < count($rsV); $i++) {
                        ...
                        $vcode2 = $rsV[$i]['vcode2'];
                        if ($vcode2!="") {
                            $rsV[$i]['courier'] = "<div class=\"hl\"><a target=\"_blank\"  href=\"http://tracking.redcourier.gr/tracking?voucher=$vcode2\">".$rsV[$i]['courier']."</a></div>";
                        }
        ...
        <div style="position: fixed; bottom:0px; right:0px; background-color: white; padding: 1em; 
             border-top:1px solid rgb(200,200,200); border-left:1px solid rgb(200,200,200)">
