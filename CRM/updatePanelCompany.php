...
//pending update COMMENT, EXPIRES, STATUS
...
//$companyPanel->set_catalogueid(0);
...
if (!isset($printPanelId)) {
    echo "PANEL ID = ".$companyPanel->get_id();
}
$panelMsg = "PANEL ID = ".$companyPanel->get_id();