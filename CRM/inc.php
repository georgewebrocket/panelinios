...
$db1 = new DB(conn1::$connstr,conn1::$username,conn1::$password); //crm panel 

$db2 = new DB(conn2::$connstr,conn2::$username,conn2::$password); //crm epag
...
$appHost = "https://crm.panelinios.gr";
