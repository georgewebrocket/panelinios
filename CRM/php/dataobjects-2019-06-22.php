...
protected $_myconn, $_id, $_parentid, $_description, $_description_en, $_level, $_path, $_active, $_nodes ;
protected $_seo_title, $_seo_description, $_seo_url;
...
protected $_myconn, $_id, $_idate, $_company, $_icode, $_description, $_amount, $_vat, $_comment, $_status, $_companyname, $_profession, $_address, $_zipcode, $_city, $_area, $_phone, $_afm, $_doy, $_series, $_accesstoken, $_paymethod ;
...
public function get_seriesCode() {
    return func::vlookup("code", "INVOICESERIES", "id=".$this->_series, $this->_myconn);
}
