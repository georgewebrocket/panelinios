...
if ($company->get_catalogueid()!="" && $company->get_catalogueid()!=0) {  
    $companyURL = file_get_contents("http://www.panelinios.gr/_getCompanyURL.php?pid=$pid");
...
<meta http-equiv="Expires" content="0" />
    ...
    <script>
        ...
        function GetStats() {
            ...
            var myUrl = "https://www.panelinios.gr/admin/ws-stats.php?id="+company;
            ...
            <div class="" style="width:180px; position: relative;">
                ...
                <div id="left-menu-more" style="display:none; position:absolute; top:0px; left:200px; z-index: 1000; padding:0px 20px 20px 0px; width: 190px;">
                    ...
                    if ($company->get_catalogueid()!="") {  ?>
                        ...
                        <?php if (($_SESSION['user_profile']>1 OR TRUE /*everybody*/)) { ?>
...
EOT;
                    ...
                    ?>
                    <iframe src="https://www.panelinios.gr/admin/edit-tags.php?id=<?php echo $myOnlineId ?>&readonly=0" width="100%" height="330" style="margin-bottom: 20px"></iframe>
                    <?php } ?>
