...
define("DEFAULT_PRODUCT_CATEGORY", 1);
            ...
            if ($company->Savedata()) {
                ...
                if ($status2 == 5) { // symfwnhse
                    ...
                    if (strpos($productCategories, "[2]")!==FALSE) {
                        if ($company->get_domain()==1) {
                            $res = file_get_contents(APP_HOST."/createChargeTransaction.php?company=$id&product=".PRODUCT_DOMAIN."&discount=0&user=$userid");
                            //echo $res;
                        }
                    }
                ...
                if ($status2 == 8) { // epistrofi - akyrwsi
                    $sql = "SELECT * FROM TRANSACTIONS WHERE status=1 "
                            . "AND transactiontype=1 AND company=".$company->get_id();
                    $rsTrans = $db1->getRS($sql);
                    $amount = 0;
        ...
        <div class="form-container">
            ...
            ?>                
                ...
                <form action="companyChangeStatus.php?company=<?php echo $company->get_id(); ?>&confirm=1&status1=<?php echo $status1; ?>&status2=<?php echo $status2; ?>" method="POST">
                    ...
                    $l_productcategories = new selectList("l_productcategories", "PRODUCT_CATEGORIES", DEFAULT_PRODUCT_CATEGORY, $db1);
