...
if (isset($_GET['save']) && $_GET['save'] == 1) {
    ...
    if ($err==0) {
        ...
        $company->set_fb_price($_POST['t_fb_price']);
        ...
        $company->set_ga_price($_POST['t_ga_price']);
            ...
            <form id="mainform" action="editcompany.php?id=<?php echo $id; ?>&save=1&<?php echo $ltoken; ?>" method="POST">
                ...
                <div class="col-12">
                    ...
                    if ($company->get_catalogueid()!="") {  ?>
                        ...
                        <?php } ?>    
                    <?php } else { ?>
<!--                        <a class="button" href="editCompanyNewSite.php?company=0&id=<?php echo $id; ?>&catalogueid=0"><?php echo $l->l("add-to-online-new-site") ?></a>&nbsp;-->
                    ...
                    <a target="_blank" title="Ανοιγμα καταχώρησης της εταιρείας στο epagelmatias.gr" class="button fancybox7000" href="https://www.epagelmatias.gr/εταιρεια/<?php echo $company->get_catalogueid(); ?>">ΑΝΟΙΓΜΑ ΚΑΤΑΧΩΡΗΣΗΣ</a>&nbsp;
                    <?php } ?>
...
EOT;
                ...
                <div class="col-6 col-md-12">
                    ...
                    /*$domainprice = func::vlookup("price", "PACKAGES", "id=15", $db1);
                    $t_domainprice = new textbox("t_domainprice", "Τιμή", $domainprice);
                    $t_domainprice->set_format("CURRENCY");
                    $t_domainprice->set_locale($locale);
                    $t_domainprice->set_disabled();
                    $t_domainprice->get_Textbox();*/
                ...
                <div id="messages" class="col-6 col-md-12">
                    ...
                    <iframe src="messages.php?showlist=0&companyid=<?php echo $id; ?>&popupurl=0&receiver=0" width="95%" height="250" frameborder="0"></iframe>
