...
<body class="form">
    <div class="form-container">
        ...
        <form action="delCompanyStatus.php?id=<?php echo $id; ?>&confirm=1&<?php echo $ltoken; ?>" method="POST">
            <h1>
                Διαγραφή status #<?php echo $companyStatus->get_id(); ?>
            </h1>
        <div class="col-4"></div>
        <div class="col-8">
