...
<body class="form">
    <div class="form-container">
        ...
        <form action="delVoucher.php?id=<?php echo $id; ?>&confirm=1&<?php echo $ltoken; ?>" method="POST">
            <h1>
                Διαγραφή voucher #<?php echo $voucher->get_vcode(); ?>
            </h1>
        <div class="col-4"></div>
        <div class="col-8">
