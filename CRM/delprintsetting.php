...
if (isset($_GET['confirm']) && $_GET['confirm']==1) {
    if ($printsetting->Delete()) {
        $msg = $l->l("printsetting-deleted")."<br/>";
    }
    else {
        $msg = $lg->l("error")."<br/>";
    }    
...
<body class="form">
    <div class="form-container">
        ...
        <form action="delprintsetting.php?id=<?php echo $id; ?>&confirm=1&<?php echo $ltoken; ?>" method="POST">
            <h1>
                <?php echo $l->l("delete-printsetting") . ' : ' . $printsetting->get_description();  ?>
            </h1>
        <div class="col-4"></div>
        <div class="col-8">
