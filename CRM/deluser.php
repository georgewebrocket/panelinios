...
<body class="form">
    <div class="form-container">
        ...
        <form action="deluser.php?id=<?php echo $id; ?>&confirm=1&<?php echo $ltoken; ?>" method="POST">
            <h1>
                <?php echo $l->l("delete-user") . ' : '; 
                echo $user->get_fullname();  ?>
                <!--echo func::vlookup("fullname", "USERS", "id=".$id, $db1) ; ?>-->
            </h1>
        <div class="col-4"></div>
        <div class="col-8">
