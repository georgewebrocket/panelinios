...
<body class="form">
    <div class="form-container">
        ...
        <form action="delprinter.php?id=<?php echo $id; ?>&confirm=1&<?php echo $ltoken; ?>" method="POST">
            <h1>
                <?php echo $l->l("delete-printer") . ' : ' . $printer->get_printername();  ?>
            </h1>
        <div class="col-4"></div>
        <div class="col-8">
