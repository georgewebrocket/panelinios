    ...
    <body>
        ...
        <?php include "blocks/menu.php"; ?>
            ...
            <div class="main">
                ...
                <h2 style="margin-left:1em">ΤΙΜΟΛΟΓΙΑ EXPORT</h2>
                
                <div class="form-container">

                    <form action="exportInvoices.php?search=1" method="POST">
                        ...
                        <a target="_blank" class="button" href="exportInvoiceCustomers.php<?php echo $params; ?>">CUSTOMERS</a>

                        <a target="_blank" class="button" href="exportInvoiceHeaders.php<?php echo $params; ?>">HEADERS</a>

                        <a target="_blank" class="button" href="exportInvoiceDetails.php<?php echo $params; ?>">DETAILS</a>
