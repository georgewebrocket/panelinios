    ...
    <div class="main">
        ...
        <form class="form" action="assignCustToUsers.php" method="post">
            ...
            */
            ...
            $c_compCount = new textbox("c_compCount", "Μέγιστο πλήθος εταιρειών", $compCount);
            $c_compCount->get_Textbox();
            
            echo '<div style="clear:both;height:30px"></div>';            
            echo "<input id=\"showCount\" type=\"button\" value=\"Get Companies \" />";
